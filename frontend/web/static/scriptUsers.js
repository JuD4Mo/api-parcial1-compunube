function getUsers() {
    ...
    fetch('http://192.168.80.4:5002/api/users', {
    method: 'GET',
    headers: {
...
function updateUser() {
    ...
    fetch(`http://192.168.80.4:5002/api/users/${userId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
...
function handleLogin(event) {
  ...
  fetch('http://192.168.80.4:5002/api/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
  ...
  .then(data=> {
        // Store basic user info in sessionStorage for frontend use
...
function handleLogout() {
    fetch('http://192.168.80.4:5002/api/logout', {
        method: 'POST',
        credentials: 'include'
    })
    .then(response => {
    ...
    .then(data => {
        // Clear frontend stored info and redirect to login
